...
import { ClipboardList, Trash2, Plus, Check, Loader2, AlertTriangle, Layers } from "lucide-react";
                ...
                <Fragment key={i}>
                  {isNewSection && (
                    <div className="flex items-center gap-2 pt-1.5">
                      ...
                      <span className="text-[11px] font-semibold text-orange-600 dark:text-orange-400 bg-orange-500/10 px-2.5 py-0.5 rounded-full flex items-center gap-1">
                        <Layers className="w-2.5 h-2.5" />{l.section}
                      </span>
                      <div className="flex-1 h-px bg-orange-500/30" />
                    </div>
                  )}
                  <div className={`flex gap-1.5 items-end ${hasSections && l.section ? "pl-2 border-l-2 border-orange-500/30" : ""}`}>
